...
namespace Microsoft.VisualStudio.TestTools.UnitTesting
{
    public class PrivateObject
    {
        ...
        {
            return this.InvokeAsync(name, null, args, CultureInfo.InvariantCulture);
        }
        ...
        public Task InvokeAsync(string name, Type[] parameterTypes, object[] args, CultureInfo culture)
        {
            return this.InvokeAsync(name, BindToEveryThing, parameterTypes, args, culture);
        }
        ...
        public Task InvokeAsync(string name, BindingFlags bindingFlags, Type[] parameterTypes, object[] args, CultureInfo culture)
        {
            return this.InvokeAsync(name, bindingFlags, parameterTypes, args, culture, null);
        }
        ...
        public Task InvokeAsync(string name, BindingFlags bindingFlags, Type[] parameterTypes, object[] args, CultureInfo culture, Type[] typeArguments)
        {
            if (parameterTypes != null)
            {
                bindingFlags |= BindToEveryThing | BindingFlags.Instance;
                ...
                try
                {
                    ...
                    {
                        MethodInfo constructed = member.MakeGenericMethod(typeArguments);
                        return (Task<object>)constructed.Invoke(this.target, bindingFlags, null, args, culture);
                    }
                    else
                    {
                        return (Task<object>)member.Invoke(this.target, bindingFlags, null, args, culture);
                    }
                }
                catch (TargetInvocationException e)
                {
            ...
            {
                return (Task)this.InvokeHelperAsync(name, bindingFlags | BindingFlags.InvokeMethod, args, culture);
            }
        }
        ...
        {
            return (T)this.GetProperty(name, null, args);
        }
        ...
        private Task InvokeHelperAsync(string name, BindingFlags bindingFlags, object[] args, CultureInfo culture)
        {
            Debug.Assert(this.target != null, "Internal Error: Null reference is returned for internal object");
            ...
            try
            {
                return (Task)this.originalType.InvokeMember(name, bindingFlags, null, this.target, args, culture); ;
            }
            catch (TargetInvocationException e)
            {
                Debug.Assert(e.InnerException != null, "Inner exception should not be null.");
